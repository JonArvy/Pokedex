...
import sz.sapphirex.pokedex.data.repository.MoveListRepositoryImpl
...
object RepositoryModule {
    ...
    @Provides
    @Singleton
    fun provideMoveListRepository(api: PokeApi, pokemonDao: PokemonDao): MoveListRepository {
        return MoveListRepositoryImpl(api, pokemonDao)
    }
}